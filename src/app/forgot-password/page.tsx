    ...
    <div dir="rtl" style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex", fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div className="auth-brand" style={{
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: "400px" }}>
          ...
          <h1 style={{ fontSize: "2.2rem", fontWeight: 900, color: "#fff", marginBottom: "0.75rem", lineHeight: 1.3, animation: "fadeInUp 0.8s ease-out 0.1s both" }}>استعادة الوصول</h1>
          <p style={{ fontSize: "1.05rem", color: "rgba(255,255,255,0.8)", marginBottom: "2.5rem", lineHeight: 1.8, animation: "fadeInUp 0.8s ease-out 0.2s both" }}>سنرسل لك رابطاً آمناً لإعادة تعيين كلمة المرور عبر بريدك الإلكتروني</p>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", animation: "fadeInUp 0.8s ease-out 0.3s both" }}>
            {[{ i: "📧", t: "رابط آمن عبر البريد" }, { i: "⏱️", t: "صالح لمدة ساعة واحدة" }, { i: "🔒", t: "حماية كاملة لبياناتك" }].map((f, idx) => (
      ...
      <div className="auth-form" style={{ flex: "1 1 50%", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: "3rem 2rem", overflowY: "auto" }}>
        <div style={{ width: "100%", maxWidth: "420px", animation: "fadeInUp 0.6s ease-out" }}>
          {!success ? (
            <>
              <h2 style={{ fontSize: "1.85rem", fontWeight: 800, color: "#0f172a", marginBottom: "0.4rem" }}>نسيت كلمة المرور؟</h2>
              <p style={{ color: "#64748b", fontSize: "0.95rem", marginBottom: "1.75rem", lineHeight: 1.6 }}>أدخل بريدك الإلكتروني وسنرسل لك رابطاً لإعادة تعيين كلمة المرور</p>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
                ...
                <div>
                  <label htmlFor="reset-email" style={{ display: "block", fontSize: "0.85rem", fontWeight: 700, color: "#374151", marginBottom: "0.5rem" }}>البريد الإلكتروني</label>
                  <div style={{ position: "relative" }}>
                    ...
                    <input id="reset-email" type="email" dir="ltr" placeholder="example@email.com" value={email} onChange={e => setEmail(e.target.value)} style={inputStyle} onFocus={focusIn} onBlur={focusOut} required />
                  </div>
                </div>

                <button id="reset-submit" type="submit" disabled={loading} style={{
                ...
                >
                  {loading ? <span style={{ display: "flex", alignItems: "center", gap: "0.5rem", justifyContent: "center" }}><span className="auth-spinner" />جاري الإرسال...</span> : "إرسال رابط الاستعادة 📩"}
                </button>
              </form>
            </>
          ) : (
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <h2 style={{ fontSize: "1.6rem", fontWeight: 800, color: "#0f172a", marginBottom: "0.75rem" }}>تم إرسال الرابط!</h2>
              <p style={{ color: "#64748b", fontSize: "0.95rem", lineHeight: 1.7, marginBottom: "0.5rem" }}>
                إذا كان هناك حساب مرتبط بـ
              </p>
              <p style={{ color: "#0f766e", fontSize: "0.95rem", fontWeight: 700, direction: "ltr" as const, marginBottom: "1rem" }}>{email}</p>
              <p style={{ color: "#64748b", fontSize: "0.9rem", lineHeight: 1.7, marginBottom: "2rem" }}>
                فستجد رابط إعادة تعيين كلمة المرور في صندوق الوارد. تحقق أيضاً من مجلد الرسائل غير المرغوب فيها.
              </p>
              ...
              <button
                ...
                style={{
                  ...
                  padding: "0.7rem 2rem", color: "#64748b", fontSize: "0.9rem", fontWeight: 600,
          ...
          <p style={{ textAlign: "center", fontSize: "0.9rem", color: "#64748b", margin: 0 }}>
            تذكرت كلمة المرور؟{" "}
            <Link href="/login" style={{ color: "#0f766e", fontWeight: 700, textDecoration: "none" }}>العودة لتسجيل الدخول</Link>
          </p>
        </div>
      </div>
